...
contract UrbangoldToken is StandardToken, usingOraclize { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function UrbangoldToken() {
        balances[msg.sender] = 141;               // Give the creator all initial tokens. This is set to 1000 for example. If you want your initial tokens to be X and your decimal is 5, set this value to X * 100000. (CHANGE THIS)
